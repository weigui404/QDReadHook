...
import cn.weigui.qdds.service.Collect
import cn.weigui.qdds.ui.MainActivity
import cn.weigui.qdds.util.CustomEditText
import cn.weigui.qdds.util.Option.initOption
import cn.weigui.qdds.util.Option.optionEntity
import cn.weigui.qdds.util.Option.updateOptionEntity
import cn.weigui.qdds.util.Option.writeTextFile
import cn.weigui.qdds.util.Utils.saveImageFromUrl
import cn.weigui.qdds.util.alertDialog
import cn.weigui.qdds.util.appModule
import cn.weigui.qdds.util.copyToClipboard
import cn.weigui.qdds.util.getName
import cn.weigui.qdds.util.getParam
import cn.weigui.qdds.util.getParamList
import cn.weigui.qdds.util.getSystemContext
import cn.weigui.qdds.util.getVersionCode
import cn.weigui.qdds.util.getView
import cn.weigui.qdds.util.getViews
import cn.weigui.qdds.util.isSelectedByTitle
import cn.weigui.qdds.util.loge
import cn.weigui.qdds.util.okButton
import cn.weigui.qdds.util.printlnNotSupportVersion
import cn.weigui.qdds.util.safeCast
